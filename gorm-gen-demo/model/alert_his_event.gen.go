...
const TableNameAlertHisEvent = "alert_his_event"

// AlertHisEvent mapped from table <alert_his_event>
type AlertHisEvent struct {
	ID               int64  `gorm:"column:id;type:bigint(20) unsigned;primaryKey;autoIncrement:true" json:"id,string"`
	IsRecovered      int64  `gorm:"column:is_recovered;type:tinyint(1);not null" json:"is_recovered"`
	...
	RecoverTime      int64  `gorm:"column:recover_time;type:bigint(20);not null" json:"recover_time"`
	LastEvalTime     int64  `gorm:"column:last_eval_time;type:bigint(20);not null;comment:for time filter" json:"last_eval_time"`
...
// TableName AlertHisEvent's table name
func (*AlertHisEvent) TableName() string {
	return TableNameAlertHisEvent
}
