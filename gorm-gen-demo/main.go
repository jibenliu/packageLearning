...
const dsn = "root:root@(localhost:3306)/n9e_v6?charset=utf8mb4&parseTime=True&loc=Local"
...
func main() {
	...
	user := g.GenerateModel("users",
		append(
			fieldOpts,
			gen.FieldRelate(field.HasMany, "UserGroupMember", g.GenerateModel("user_group_member"), &field.RelateConfig{GORMTag: tag}),
		)...,
	)
