...
func (visitor VisitorA) VisitA(a *ConcreteElementA) {
	fmt.Println("Visitor A visit element a")
	a.OperationA()
}
func (visitor VisitorA) VisitB(b *ConcreteElementB) {
	fmt.Println("Visitor A visit element b")
	b.OperationB()
}

func (visitor VisitorB) VisitA(a *ConcreteElementA) {
	fmt.Println("Visitor B visit element a")
	a.OperationA()
}
func (visitor VisitorB) VisitB(b *ConcreteElementB) {
